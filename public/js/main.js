...
var _clients = require('./clients.vue');
...
exports.default = {
  ...
  ready: function ready() {
    ...
    _bus2.default.$on('botao-foi-clicado', function (dados) {
      return _this.dtr = dados;
    }); //o script irá pegar os dados do objeto bus dinamicamente. O objeto dados está com as variaveis,
    // então basta atribuir o objeto dados ao objeto dtr. 
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2f379d5d", module.exports)
  } else {
    hotAPI.update("_v-2f379d5d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./bus":8,"vue":4,"vue-hot-reload-api":2}],8:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-278b885c", module.exports)
  } else {
    hotAPI.update("_v-278b885c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./bus":8,"vue":4,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  methods: {
    buttonClickHandler: function buttonClickHandler() {
      ...
      this.dados.name = 'Yuri Alexs';
      this.dados.email = 'yuri.alexs@gmail.com'; //preenche o objeto dados
      _bus2.default.$emit('botao-foi-clicado', this.dados); //envia o objeto para a classe bus com o nome "botao-foi-clicado"
      console.log('botao pressionado'); //debug
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1a8a1c90", module.exports)
  } else {
    hotAPI.update("_v-1a8a1c90", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./bus":8,"vue":4,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	data: function data() {
		return {
			...
			title: '',
			emailEmail: '',
			nameName: _clients2.default.nameName,
			bar: {
				msg: 'Eu sou o Bar!'
			}
		};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-46ae7c8a", module.exports)
  } else {
    hotAPI.update("_v-46ae7c8a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./clients.vue":9,"vue":4,"vue-hot-reload-api":2}],12:[function(require,module,exports){
...
exports.default = {
	...
	methods: {
		navigate: function navigate(page) {
			...
			this.$http.get('/os/list?page=' + page).then(function (req) {

				_this.listOs = req.data.data;
	...
	ready: function ready() {
		...
		this.$http.get('/cartridge/list').then(function (req) {

			_this2.listOs = req.data;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4b3739f0", module.exports)
  } else {
    hotAPI.update("_v-4b3739f0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./bus":8,"./pagination.vue":14,"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],13:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	ready: function ready() {
		...
		this.$http.get('/os/list').then(function (req) {
			...
			_this2.listOs = req.data.data; //discomment this for habilite pagination
			_this2.pagination = req.data;
		});
		// this.$http.get('/clients/list').then((req) => this.users = req.data)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4ddb3cc8", module.exports)
  } else {
    hotAPI.update("_v-4ddb3cc8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./bus":8,"./pagination.vue":14,"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],14:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-14f9a0c0", module.exports)
  } else {
    hotAPI.update("_v-14f9a0c0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _insertClient = require('./insertClient.vue');

var _insertClient2 = _interopRequireDefault(_insertClient);
...
exports.default = {
	...
	ready: function ready() {
		...
		//this.list = JSON.parse(this.users)
		this.$http.get('/usuarios/listar').then(function (req) {
			return _this.users = req.data;
		});
	}
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-57c1f9f8", module.exports)
  } else {
    hotAPI.update("_v-57c1f9f8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./insertClient.vue":11,"vue":4,"vue-hot-reload-api":2}],16:[function(require,module,exports){
'use strict';
...
var _OsCartridge = require('./components/OsCartridge.vue');

var _OsCartridge2 = _interopRequireDefault(_OsCartridge);
...
var _osCartList = require('./components/osCartList.vue');

var _osCartList2 = _interopRequireDefault(_osCartList);
...
new _vue2.default({
  ...
  components: {
    ...
    OsCartridge: _OsCartridge2.default,
    OsCartList: _osCartList2.default
...
},{"./components/OsCartridge.vue":6,"./components/bar.vue":7,"./components/bus":8,"./components/clients.vue":9,"./components/foo.vue":10,"./components/insertClient.vue":11,"./components/osCartList.vue":12,"./components/osList.vue":13,"./components/services.vue":15,"vue":4,"vue-resource":3}]},{},[16]);
